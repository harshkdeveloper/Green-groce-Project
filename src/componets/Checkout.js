                                ...
                                <div class="accordion" id="accordionExample">
                                    <div class="card checkout-step-one">
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    We need your phone number so
                                                    that we can update you about
                                                    your order.
                                                </p>
                                                <form>
                                            ...
                                            <div class="card-body">
                                                <form class="col-lg-8 col-md-8 mx-auto">
                                                    ...
                                                    <p>
                                                        Vestibulum semper
                                                        accumsan nisi, at
                                                        blandit tortor maxi'mus
                                                        in phasellus malesuada
                                                        sodales odio, at dapibus
                                                        libero malesuada quis.
                                                    </p>
                                                    <button
                                                        type="button"
                                                        type="button"
                        ...
                        <div class="col-lg-3 col-md-3">
                            ...
                            <p class="mb-0">
                                <a class="text-dark" href="#">
                                    <i class="mdi mdi-phone"></i> +61 525 240
                                    310
                                </a>
                            </p>
                            <p class="mb-0">
                            ...
                            <p class="mb-0">
                                <a class="text-success" href="#">
                                    ...
                                    <span
                                        class="__cf_email__"
                                        data-cfemail="4b222a2624382a232a250b2c262a222765282426"
                                    >
                                        [email&#160;protected]
                                    </span>
                                </a>
                ...
                <div class="container">
                    <div class="row no-gutters">
                        <div class="col-lg-6 col-sm-6">
                            <p class="mt-1 mb-0">
                                &copy; Copyright 2020{" "}
                                <strong class="text-dark">Groci</strong>. All
                                Rights Reserved
                                <br />
            ...
            <div class="cart-sidebar">
                ...
                <div class="cart-sidebar-footer">
                    <div class="cart-store-details">
                        <p>
                            Sub Total{" "}
                            <strong class="float-right">$900.69</strong>
                        </p>
                        <p>
                            Delivery Charges{" "}
                    ...
                    <a href="checkout.html">
                        ...
                        >
                            <span class="float-left">
                                <i class="mdi mdi-cart-outline"></i> Proceed to
                                Checkout{" "}
                            </span>
